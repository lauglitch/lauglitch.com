...
<html lang='es' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
        ...
        <nav class='navbar-right' style='animate: true; transition: all 0.15s;'>
            ...
            <div id='keypadsInicio' style='margin-top: 25px; margin-right: 20px; display: block'>
                <table style='margin-left: 25px;'>
                    <tr>
                      <td style='padding-right: 20px;'> <a id='spanishButton' class='hoverButton'><img height='50' src='https://imgur.com/zuWBFor.png' width='50'/></a> </td>
                      <td style='padding-right: 20px;'> <a id='englishButton' class='hoverButton'><figure><img height='50' src='https://imgur.com/K5Ui26c.png' width='50'/></figure></a> </td>
                      <td style='padding-right: 20px;'> <a id='contactButton' class='botonContacto botonContacto2 hoverButton'><figure><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></figure></a> </td>
                   </tr>
                </table>
            </div>     
  ...
  <!-- JS Logic -->
   <script defer='defer' src='https://lauglitch.github.io/lauglitch.com/V1.1/lauglitchLogicV1.1.js'></script> 
  <!-- END JS Logic --> 
