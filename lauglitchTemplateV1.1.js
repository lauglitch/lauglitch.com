...
<html lang='es' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
  ...
  <body>
                ...
                <b:if cond='data:useImage'>
                  ...
                  <div id='header-inner'>
                    <div class='titlewrapper'>
                      ...
                      <!-- EN: Página Contacto-->
                      <div id='lauglitchLogoContact'>
                          <h1 class='h-title'>
                            <a class='hoverButton' href='https://www.lauglitch.com/p/home.html'><figure><img height='80' src='https://i.imgur.com/SCBJ3WO.png' width='240'/></figure></a>
                          </h1>
                        <b:include name='description'/>
                      </div>
        ...
        <nav class='navbar-right' style='animate: true; transition: all 0.15s;'>
            ...
            <div id='keypadsInicio' style='margin-top: 25px; margin-right: 20px; display: block'>
                <table style='margin-left: 25px;'>
                    <tr>
                      <td style='padding-right: 20px;'> <a class='hoverButton'><img height='50' src='https://imgur.com/zuWBFor.png' width='50'/></a> </td>
                      <td style='padding-right: 20px;'> <a class='hoverButton' onclick='redirectToHomeEN()'><figure><img height='50' src='https://imgur.com/K5Ui26c.png' width='50'/></figure></a> </td>
                      <td style='padding-right: 20px;'> <a class='botonContacto botonContacto2 hoverButton' onclick='redirectToContactES()'><figure><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></figure></a> </td>
                   </tr>
                </table>
            </div>     

             <!-- EN: Home -->
            <div id='keypadsHome' style='margin-top: 25px; margin-right: 20px; display: none'>
                <table style='margin-left: 25px;'>
                    <tr>
                        <td style='padding-right: 20px;'><a class='hoverButton' onclick='redirectToHomeES()'><figure><img height='50' src='https://imgur.com/zuWBFor.png' width='50'/></figure></a></td>
                        <td style='padding-right: 20px;'><a class='hoverButton'><img height='50' src='https://imgur.com/K5Ui26c.png' width='50'/></a></td>
                        <td style='padding-right: 20px;'><a class='botonContacto botonContacto2 hoverButton' onclick='redirectToContactEN()'><figure><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></figure> </a></td>
                    </tr>
                </table>
            </div>

            <!-- ES: Contacto -->
            <div id='keypadsContacto' style='margin-top: 25px; margin-right: 20px; display: none'>
                <table style='margin-left: 25px;'>
                    <tr>  
                        <td style='padding-right: 20px;'><a class='hoverButton'> <img height='50' src='https://imgur.com/zuWBFor.png' width='50'/>
                        </a></td>
                        <td style='padding-right: 20px;'><a class='hoverButton' onclick='redirectToContactEN()'><figure><img height='50' src='https://imgur.com/K5Ui26c.png' width='50'/></figure> </a></td>
                        <!-- Desactivamos el botonContacto en la Página Contacto -->
                        <td style='padding-right: 20px;'><a class='botonContacto'><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></a></td>
                   </tr>
                </table>
            </div>

            <!-- EN: Contact -->
            <div id='keypadsContact' style='margin-top: 25px; margin-right: 20px; display: none'>
                <table style='margin-left: 25px;'>
                    <tr>
                        <td style='padding-right: 20px;'><a class='hoverButton' onclick='redirectToContactES()'><figure><img height='50' src='https://imgur.com/zuWBFor.png' width='50'/></figure></a></td>
                        <td style='padding-right: 20px;'><a class='hoverButton'><img height='50' src='https://imgur.com/K5Ui26c.png' width='50'/> </a></td>
                        <!-- Desactivamos el botonContacto en la Página Contacto -->
                        <td style='padding-right: 20px;'><a class='botonContacto'><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></a></td>
                    </tr>
    ...
    <div id='body-templates'>
      ...
      <!-- ES: Cuerpo Contacto -->
      <div id='bodyContacto'>
        <div id='container' class='container row bloqueContacto' style='margin-bottom:30px;'>
