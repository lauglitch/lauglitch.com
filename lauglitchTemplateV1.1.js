...
<html lang='es' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
    ...
    <nav class='navbar navbar-inverse navbar-static-top justify-content-between'>
      <div class='container'>
        ...
        <nav class='navbar-right' style='animate: true; transition: all 0.15s;'>
            ...
            <!-- ES: Inicio -->
            <div id='keypadsInicio' style='margin-top: 25px; margin-right: 20px;'>
                <table style='margin-left: 25px;'>
                    <tr>
                      <td style='padding-right: 20px;'> <a class='hoverButton'><img height='50' src='https://imgur.com/q75nbXt.png' width='50'/></a> </td>
                      <td style='padding-right: 20px;'> <a class='hoverButton' onclick='redirectToHomeEN()'><figure><img height='50' src='https://imgur.com/7cP1sy2.png' width='50'/></figure></a> </td>
            ...
            <div id='keypadsHome' style='margin-top: 25px; margin-right: 20px; display: none'>
                <table style='margin-left: 25px;'>
                    <tr>
                        <a class='hoverButton' onclick='redirectToHomeES()'><figure><img height='50' src='https://imgur.com/q75nbXt.png' width='50'/></figure></a>
                        <a class='hoverButton'><img height='50' src='https://imgur.com/7cP1sy2.png' width='50'/></a>
                        <a class='botonContacto botonContacto2 hoverButton' onclick='redirectToContactEN()'><figure><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></figure> </a>
                    </tr>
                </table>
            </div>
            ...
            <div id='keypadsContacto' style='margin-top: 25px; margin-right: 20px; display: none'>
                <table style='margin-left: 25px;'>
                    <tr>  
                        <a class='hoverButton'> <img height='50' src='https://imgur.com/q75nbXt.png' width='50'/>
                        </a>
                        <a class='hoverButton' onclick='redirectToContactEN()'><figure><img height='50' src='https://imgur.com/7cP1sy2.png' width='50'/></figure> </a>
                        <!-- Desactivamos el botonContacto en la Página Contacto -->
                        <a class='botonContacto'><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></a>
                   </tr>
                </table>
            </div>
            ...
            <div id='keypadsContact' style='margin-top: 25px; margin-right: 20px; display: none'>
                <table style='margin-left: 25px;'>
                    <tr>
                        <a class='hoverButton' onclick='redirectToContactES()'><figure><img height='50' src='https://imgur.com/q75nbXt.png' width='50'/></figure></a>
                        <a class='hoverButton'><img height='50' src='https://imgur.com/7cP1sy2.png' width='50'/> </a>
                        <!-- Desactivamos el botonContacto en la Página Contacto -->
                        <a class='botonContacto'><img height='50' src='https://i.imgur.com/gSjJPIL.png' width='50'/></a>
                    </tr>
  ...
  <!-- JS Logic --> 
  <script defer src="https://cdn.jsdelivr.net/gh/lauglitch/lauglitch.com@main/lauglitchLogic.js">
  </script>
  <!-- END JS Logic --> 
